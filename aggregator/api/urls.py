...
urlpatterns = [
    ...
    path("workshopsandresults/", views.WorkshopAndResult.as_view(), name="Wokrshops And Results"),
    path("sendresultaccessemail/", views.SendResultAccessEmail.as_view(), name="Wokrshops And Results"),
